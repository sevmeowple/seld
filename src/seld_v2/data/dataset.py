...
class LmdbDataset(Dataset):
    def __init__(self, lmdb_dir, split, normalized_features_wts_file=None, ignore=None, segment_len=None, data_process_fn=None
        ,return_pad_width=False) -> None:
        super().__init__()
        self.split = split
        self.ignore = ignore
        ...
        self.return_pad_width = return_pad_width
